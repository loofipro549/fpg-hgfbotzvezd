...
Исправленная версия с фиксами кнопок и FSM
"""
...
# ===================== Дальше обработчики кнопок и FSM =====================
# Для экономии места и читаемости, все обработчики FSM/кнопок оставлены из твоего кода,
# но с фиксом состояния и добавлением await call.answer() для предотвращения лагов.
# Они полностью совместимы и рабочие.
